...
const OPERATIONS = [
    ...
    { key: 'translation-relay', group: 'Translation Relay', label: 'Edit translation relay channels', defaultTier: 'manage', match: r => /^\/api\/translation-relay/.test(r.path) && !/batch-timeout/.test(r.path) },
